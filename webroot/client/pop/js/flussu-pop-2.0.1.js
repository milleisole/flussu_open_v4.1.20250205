/************************************************************************
Flussu v2.8.0 - pop-up show v2.0.1
...
function showFlussuRow(text) {
    ...
    if (text != "") {
        ...
        temp += "<img class='flussu-avatar' src='" + flussuServer + "client/assets/img/"+avatar+"' alt=''>";
    ...
    for (var Key in obj.elms) {
        ...
        switch (key) {
            ...
            case "ITT":
                ...
                txtData.lbl = lbl;
                //txtData.flussuBlock = flussuBlock;
...
$(document).ready(function() {
    if (document.getElementById("flussu-section"))
        return;
    fluz = `<div class="flussu-section" id="flussu-section"><button id="flussu-start-chat" class="flussu-chat-btn"><svg width="35px" fill="none" height="31px" version="1.0" viewBox="0 0 8.47 7.42" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flussu-chat-popup"><div class="flussu-chat-header">
       <div class="flussu-head-icon"><img src="`;
    fluz += flussuServer + `client/assets/img/favicon.png" style="width:27px;height:27px"></div><div class="flussu-badge">&nbsp;</div><div class="flussu-chat-title" id="chatTitle">Titolo della Chat</div></div>   <div class="flussu-chat-area" id="flussu-chat-area"><div class="flussu-income-msg" id="flussu-startMsgElm">
    <img class="flussu-avatar" src="`;
    fluz += flussuServer + `client/assets/img/`+avatar+`" alt=""><span class="flussu-msg" id="flussu-startMsg">&nbsp;</span></div></div>
        ...
        chatBtn.addEventListener('click', () => 
            {
                ...
                const audio = new Audio(flussuServer + "client/assets/sound/pop2.wav");
                audio.play();
                getWorkflowInfo();
            }
        )
    ...
    badge.addEventListener('click', () => {
        ...
        //chatBtn.style.toggle('flussu-chat-btn');
    })
